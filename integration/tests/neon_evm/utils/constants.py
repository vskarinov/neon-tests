...
COUNTER_ID: PublicKey = PublicKey("BDST2Fd5P9B4Lh8fz12CFmUJy6QPt7kRPqxrNXf5hPWk")
TRANSFER_SOL_ID: PublicKey = PublicKey("4A8A5JbpB8phdAaMYhZYjTpFgdiLVWkb65rAiyjR9rAF")
TRANSFER_TOKENS_ID: PublicKey = PublicKey("55xocMHTxPwwE1yoftfC1c8XBVSvjhTYpUdJWVCPsNTm")
