...
def _create_mint_and_accounts(solana_client, from_wallet, to_wallet, amount):
...
class TestInteroperability:
    ...
    def test_create_resource(self, sender_with_tokens, solana_caller, solana_client):
        salt = b"123"
        size = 8
    ...
    def test_execute_from_account_create_acc(self, sender_with_tokens, solana_caller, solana_client):
    ...
    def test_transfer_with_PDA_signature(self, solana_caller, sender_with_tokens, solana_client):
        ...
        mint, from_token_account, to_token_account = _create_mint_and_accounts(
            solana_client, from_wallet, to_wallet, amount
        )
    ...
    def test_transfer_tokens_with_ext_authority(self, solana_caller, sender_with_tokens, solana_client):
        from_wallet = sender_with_tokens
        to_wallet = Keypair.generate()
        amount = 100000
        mint, from_token_account, to_token_account = _create_mint_and_accounts(
            solana_client, from_wallet.solana_account, to_wallet, amount
        )
        seed = b"myseed"
    ...
    def test_transfer_tokens_with_unauthorized_signer(self, solana_caller, sender_with_tokens, solana_client):
        from_wallet = sender_with_tokens
        to_wallet = Keypair.generate()
        amount = 100000
        mint, from_token_account, to_token_account = _create_mint_and_accounts(
